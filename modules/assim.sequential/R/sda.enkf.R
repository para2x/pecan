...
>>>>>>> 295efdc9b83cbb55a0b3e29f396a9a93584b7334
    }else{
  ...
  for(t in seq_len(nt)) {
    ...
    if (any(obs)) {
      ...
      if (processvar == FALSE) {
        ...
        pdf(file.path(outdir,paste0('1assessParams',t,'.pdf')))
...
#      }
  ...
  pdf(file.path(settings$outdir, "1sda.enkf.time-series.pdf"))
  ...
  ### bias diagnostics                                                  ###
  ###-------------------------------------------------------------------###
  pdf(file.path(settings$outdir, "1bias.diagnostic.pdf"))
