sda.enkf.refactored <- function(settings,
  ...
  # When processvar == FALSE it means we are doing EnKF and when it's TRUE Generlized Ensemble Filter
  # Generlized Ensemble Filter NEEDS process variance to avoid filter divergence and it does not
  ...
  # then start date in the second xml should be the same as the first sda and pecan xml.
